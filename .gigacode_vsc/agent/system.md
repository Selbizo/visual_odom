...
- НУЖНО ОТРАБОТАТЬ:  **должно точно происходить loop closure между кадрами 130 и 1576, 131 и 1577 и так далее до пары 182 и 1623**. Давай будем **на основе этого строить отладочный процесс**.
